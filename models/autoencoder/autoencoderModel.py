...
#  autoencoder for the WW1 logbook images. The model has two sub-models
...
class generatorModel(tf.keras.Model):
    def __init__(self):
        ...
        self.unpack_from_l = tf.keras.layers.Dense(16 * 16 * 512,)
        self.unflatten = tf.keras.layers.Reshape(target_shape=(16, 16, 512,))
        # Starts at (16,16,512)
